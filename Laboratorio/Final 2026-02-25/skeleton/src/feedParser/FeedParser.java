...
/**
 * Abstract class representing a parser capable of extracting articles from a
 * feed.
 * <p>
 * Subclasses of {@code FeedParser} must implement the
 * {@link #parseFeed(String, int)} method
 * to parse the feed content and extract a {@link Feed} containing its articles.
 * </p>
 * <p>
 * Provides an overloaded {@link #parseFeed(String)} method for convenience,
 * which parses
...
public abstract class FeedParser {
    ...
    /**
     * Parses the provided feed content, extracting up to {@code limit} articles
     * into a {@link Feed}.
     *
    ...
    /**
     * Parses the provided feed content, extracting all available articles without
     * limit.
     *
